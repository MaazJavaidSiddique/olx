...
// import Card1 from '../images/pexels-ralph-rabago-3214789.jpg'
// import map from '../images/Opera Snapshot_2020-11-02_193350_www.google.com.png'
// import imac1 from '../images/pexels-pixabay-38568.jpg'
// import imac2 from '../images/pexels-lee-campbell-115655.jpg'
                            ...
                            <div>  
                                ...
                                <div className="heading">
                                   <div className="icon1">
                                    ...
                                    <h2 className="card-title1">{this.props.name1}</h2>
                                </div>
                      ...
                      <Card className="cardcont3">
                        <Card.Body>
                          ...
                          <div className="detail">
                            <Image src={this.props.img4} className="round" roundedCircle /> 
                            <div className="center">
                             <ul>
                                <li><p>{this.props.selllerid}</p></li>

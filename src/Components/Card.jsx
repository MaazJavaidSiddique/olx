...
class Card extends React.Component{
    render(){
        return(
          <Link style={{color:'black',textDecoration: 'none'}} className="CardText" to={{pathname:'/product',
        aboutProps:{
          ...
          <div className="shopCard">
              ...
              <img className="card-img-top card-img-size mainimage" src={this.props.src} alt="Card image cap" />
